    ...
    $('.close_button').click(function(){
        ...
        if(device.mobile() || device.ipad() || device.android())
            ...
            setTimeout(function(){
            $('#apYou').hide();
            $("#ytplayer").append("<iframe width=\"560\" height=\"315\" src=\"https://www.youtube.com/embed/RbM1-CCXPmk?mute=0&amp;autoplay=1&amp;controls=1&amp;disablekb=0&amp;loop=1&amp;modestbranding=1&amp;rel=0&amp;showinfo=0&amp;playlist=RbM1-CCXPmk\" frameborder=\"0\" allowfullscreen=\"\"></iframe>");
        },2000) 
        }
        else {
